...
$langues = array(
	'en' => array(
		...
		'toolinfo' => 'Tools',
		'txtProject' => 'My Projects',
		'txtNoProject' => 'No projects yet.<br />To create a new one, just create a directory in \'www\'.',
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
    ...
    <meta name="Description" content="Personal main landing page of launching demo projects sites in MAMP. Demo projects are written in PHP, implementing concepts for performance, accessibility and SEO.  All demo projects are written in JavaScript, CSS and XHTML-Strict.">
    <meta name="Keywords" content="Personal main, main landing page, launching demo projects, MAMP, Apache, PHP, MySQL, XHTML-Strict, JavaScript, script, CSS, style phpinfo, phpMyAdmin, SQLLiteManage, accessibility, mysite, demo, demos, tools, Version Info, My Projects, Hans, localhost">
...
#foot {
  ...
  <body>
        ...
        <h2>{$langues[$langue]['versionInfo']}</h2>
